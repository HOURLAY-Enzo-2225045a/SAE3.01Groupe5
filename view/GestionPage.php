...
function start_page($title): void
{
    ...
    <header class="bg-cover bg-bottom bg-no-repeat h-[30vh] w-full relative" style="background-image: url('/assets/images/header.png')">
        <a href="https://marseillehockeyclub.com"><img class="w-1/5 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" src="/assets/images/logo.png" alt="lg-logo"></a>
...
<?php function end_page(): void
{
    ...
    <footer class="bg-cover bg-center h-[50vh] w-full relative" style="background-image: url('/assets/images/footer.png')">
