...
<div class="result grid gap-4 p-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
    <?php foreach($data as $spartiate){ ?>
        <div class="spartCard cursor-pointer flex flex-col items-center justify-center w-full p-6 bg-white border border-gray-200 rounded-lg shadow-md" data-id="<?= $spartiate->getSpart_id()?>">
            <?php
