...
<div class="w-full">
    ...
    <div class="w-full flex justify-center items-center text-4xl"><h2 class="bg-customBlue p-5 rounded-xl"
                                                                      id="code"></h2>
    </div>
    <div class="md:px-5 lg:w-full flex flex-row justify-center items-center">
        <a class="bg-white lg:w-1/3 md:w-full md:h-[8vh] py-8 md:py-6 drop-shadow-xl md:text-4xl lg:text-xl my-4 mx-1 rounded-lg flex justify-center items-center cursor-pointer buttonWS"
    ...
    <div class="md:px-5 lg:w-full flex flex-row justify-center items-center">
        <a class="bg-customBlue lg:w-1/3 md:w-full md:h-[8vh] py-8 md:py-6 drop-shadow-xl md:text-4xl lg:text-xl my-4 mx-1 rounded-lg flex justify-center items-center cursor-pointer"
