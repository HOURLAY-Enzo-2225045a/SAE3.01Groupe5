...
<div class="flex flex-col items-center justify-center">
    <button class="button bg-blue-500" onclick="window.location.href='/newQuestion'">Ajouter une question</button>
            ...
            <div class="flex flex-col items-center justify-center w-full p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                <div class="flex flex-row items-center justify-between w-full mt-2">
                    ...
                    <div class="flex flex-row space-x-2">
                        <a href="/updateQuestion/<?= $question->getQuestion_id() ?>" class="inline-block w-8 h-8 bg-blue-500 hover:bg-blue-700 rounded">
                            <img class="p-1" src="/assets/images/edit.svg" alt="Delete">
                        </a>
                        <a href="/adminPages/questions?action=deleteQuestion&id=<?= $question->getQuestion_id() ?>" class="inline-block w-8 h-8 bg-red-500 hover:bg-red-700 rounded">
